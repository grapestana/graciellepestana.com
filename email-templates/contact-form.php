...
if( ! empty( $_POST['email'] ) ) {
	...
	$receiver_email = 'contato@graciellepestana.com';

	// Email Receiver Name for SMTP Email
	$receiver_name 	= 'Gracielle Pestana';
	...
	$message = '
		...
		<tr>
		<td colspan="2" align="center" valign="top"><img style="margin-top: 15px;" src="https://graciellepestana.com/images/logo-email.png" ></td>
		</tr>
		<tr>
